...
Analysis of the relationship between physical activity and heart disease risk using CDC BRFSS data, SQL, Python, and logistic regression.
...
The model achieved an ROC-AUC score of 0.82, exceeding the project benchmark of 0.70 and demonstrating good class-separation ability.
...
A Matplotlib ROC curve was used to evaluate the model's classification performance and visualize the ROC-AUC score.

## Conclusion

The analysis supports the hypothesis that physical activity is associated with a reduced likelihood of heart disease.

Although the model struggled to identify all positive heart disease cases due to class imbalance, it demonstrated strong overall discrimination with an ROC-AUC score of 0.82.

These findings suggest that physical activity may be an important modifiable risk factor and support the use of preventive health initiatives aimed at increasing physical activity levels.
